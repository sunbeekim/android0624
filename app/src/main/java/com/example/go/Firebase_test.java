...
//firebase 참고 사이트 https://firebase.google.com/docs/auth/android/start?hl=ko
//sha1 key 참고 사이트 https://chobodogfootruler.tistory.com/28
public class Firebase_test extends AppCompatActivity { //로그인
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           Snackbar.make(findViewById(R.id.activity_auth), "Authentication Failed.", Snackbar.LENGTH_LONG).show();
                            updateUI(null);
                        }
                    }
                });
